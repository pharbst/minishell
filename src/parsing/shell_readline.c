...
/*   Updated: 2023/03/31 08:09:26 by pharbst          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_prompt_line(t_shell *shell)
{
	...
	tmp = strjoinfree(ft_strdup("\001\033[1;3"),
			ft_strjoinfree(ft_itoa(i % 7 + 1), "m\002"));
	...
	line = ft_strjoinfree(line, "$ \001\033[0;37m\002");
	i++;
	return (line);
}
